            ...
            <Modal show={mostraModal} onHide={() => setMostraModal(false)}>
                ...
                <Modal.Body>
                    <Form onSubmit={btnEnviar}>
                        ...
                        <Form.Select aria-label="Default select example" type='select' className='mt-3' value={dificuldade} onChange={(e) => setDificuldade(e.target.value)}>
                ...
                <Modal.Footer>
                    <Button variant="danger" onClick={() => setMostraModal(false)}>
                        Cancelar
                    </Button>
                </Modal.Footer>
            </Modal>
